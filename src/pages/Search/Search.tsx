...
//     label: string;
// };
// const searchTypeOptions: SearchOption[] = [
...
//     const { executeSearch, setSearch, search, media } = useSearchMedia(option.value, searchType);
//     const trendingTodayRow = trendingToday.map(media => {
//         return (
//             <MediaCard media={media} key={media.id}/>
//         )
...
//                             value={searchTypeOptions.find(o => o.value === searchType)}
//                             onChange={(opt) => setSearchType(opt?.value ?? "regular")}
//                         />
//                     </>
//                 }
//             />
