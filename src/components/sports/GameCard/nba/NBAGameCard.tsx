...
export const NBAGameCard: React.FC<Props> = ({
  game,
  card,
  className = "",
}) => {
  ...
  const periodText =
    isPregame
      ...
      : game.period?.type === "OT"
        ...
        : isFinal
          ? "Final"
          : `${currentPeriod}${getOrdinalSuffix(currentPeriod ?? 1)} QTR`;
